...
import ReferencesPanel from '@/components/citations/ReferencesPanel';
...
const AthroChat: React.FC<AthroChatProps> = ({ isCompactMode = false }) => {
  ...
  return (
    <div className="flex h-full">
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {msg.senderId !== 'user' && activeCharacter?.supportsMathNotation && !msg.citations ? (
                        <AthroMathsRenderer content={msg.content} />
                      ) : msg.senderId !== 'user' && msg.citations && msg.citations.length > 0 ? (
                      ...
                      {msg.senderId !== 'user' && msg.referencedResources && msg.referencedResources.length > 0 && !msg.citations && (
                        <div className="mt-2 pt-2 border-t border-gray-200">
      ...
      {allCitations.length > 0 && !isCompactMode && (
        <CitationSidebar 
