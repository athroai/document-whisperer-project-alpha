...
import { toExtendedUpload } from '@/types/extended-upload';
import type { ExtendedUpload } from '@/types/extended-upload';
...
export { toExtendedUpload };
export type { ExtendedUpload };
